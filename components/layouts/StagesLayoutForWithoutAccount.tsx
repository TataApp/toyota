...
export default function StagesLayoutForWithoutAccount({ Stages, onFinish }: { Stages: StageForWithoutAccount[], onFinish: () => void }) {
    ...
    const doubleNextHundller = async () => {
    ...
    return (
        <View style={styles.container}>
            <Animated.View style={[
                ...
                {Stages[currentStage].Component(nextHundler,doubleNextHundller,doubleBackHundler, backHundler,  finishHundler )}
            </Animated.View>
        </View>
    )
}
